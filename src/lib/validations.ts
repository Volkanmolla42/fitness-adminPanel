...
export const memberSchema = z.object({
  ...
  subscribedServices: z.array(z.string()).min(1, "En az bir hizmet seçilmelidir"),
...
export const trainerSchema = z.object({
  ...
  phone: z.string()
    .regex(phoneRegex, validationMessages.phone),
  specialization: z.array(z.string()).min(1, "En az bir uzmanlık alanı seçilmelidir"),
...
export const serviceSchema = z.object({
  name: z.string()
    .min(2, validationMessages.minLength("Hizmet adı", 2)),
