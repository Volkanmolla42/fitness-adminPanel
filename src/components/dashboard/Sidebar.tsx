...
const SidebarContent = React.memo(({
  ...
  return (
    <div className={cn("flex flex-col h-svh flex-nowrap bg-background text-foreground overflow-hidden will-change-transform", className)}>
      {/* Logo Area */}
      <div className={cn("flex flex-col items-center mt-6 mb-8 shrink-0", {
        "gap-2": isCollapsed,
        "gap-4": !isCollapsed
      })}>
        ...
        <div className={cn("transition-transform duration-200", {
          ...
          {!isCollapsed && <span className="font-semibold text-xl truncate text-foreground">LOCA FIT STUDIO</span>}
        </div>
      </div>
              ...
              <Tooltip key={item.path}>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <span className={cn("transition-transform duration-200", {
