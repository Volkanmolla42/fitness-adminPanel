...
import { Plus, ListFilter, CreditCard, Coins, Calculator, Calendar } from "lucide-react";
...
export const PaymentSummary: React.FC<PaymentSummaryProps> = ({ summary, setIsAddingPayment }) => {
  return (
